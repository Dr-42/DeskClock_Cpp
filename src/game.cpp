...
void Game::Init(){
    // load shaders
    ResourceManager::LoadShader("F:/C++/Clock/src/shaders/sprite_vert_shad.glsl", "F:/C++/Clock/src/shaders/sprite_frag_shad.glsl", nullptr, "sprite");
    ResourceManager::LoadTexture("F:/C++/Clock/src/textures/clock_face.png", true, "face");
    ResourceManager::LoadTexture("F:/C++/Clock/src/textures/clock_hand.png", true, "hand");

    const char* fontPath = "F:/C++/Clock/src/fonts/OCRAEXT.TTF";
    ResourceManager::LoadShader("F:/C++/Clock/src/shaders/text_vert_shad.glsl", "F:/C++/Clock/src/shaders/text_frag_shad.glsl", nullptr, "text");
...
void Game::Update(float dt)
{
    ...
    if(second == 0 && minute == 0 && !played){
        played = PlaySound(TEXT("F:/C++/Clock/src/sound/Gong.wav"), NULL, SND_FILENAME | SND_ASYNC);
    }
